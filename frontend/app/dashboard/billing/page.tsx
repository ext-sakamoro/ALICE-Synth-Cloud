...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['5 presets', '30s render limit', '44.1kHz output', 'Community support'] },
  { name: 'Pro', price: '$49/mo', features: ['Unlimited presets', '10min render limit', '96kHz output', 'All synth types', 'Priority rendering'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited everything', 'Custom DSP chains', 'Dedicated rendering', 'SLA guarantee', 'Dedicated support'] },
];
